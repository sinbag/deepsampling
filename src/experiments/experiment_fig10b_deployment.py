###
# This is to illustrate how to use already trained kernels at deployment stage.
# Below in buildEnvironment(), we direct weightDir = "../fig10b-bnot-step-jitter/kernels/"
# where the trained kernels are stored.
###
import fourier
import pcf
...
def buildEnvironment():
    ...
    trainingSetup = setup.TrainingSetup(
        ...
        storeNetwork = True,
        backupInterval = 5000,
        weightDir = "../fig10b-bnot-step-jitter/kernels/"
    )
